...
ALTER TABLE "deployment_services" DROP CONSTRAINT "deployment_services_deployment_id_service_id_key";
ALTER TABLE "deployment_services" ADD CONSTRAINT "deployment_services_deployment_id_service_id_pod_name_names_key" UNIQUE ("deployment_id", "service_id", "pod_name", "namespace");
